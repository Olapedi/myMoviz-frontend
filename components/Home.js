...
function Home() {
  ...
  useEffect(()=>{
    ...
    .then((data)=>{
      ...
      //   if(movie.overview.length>250){movie.overview = movie.overview.substring(0,249)+'...'}

      //   const { title, poster_path, vote_average, vote_count, overview } = movie;
      //   const movieObj = {
      //     title: title,
      //     poster: `https://www.themoviedb.org/t/p/w600_and_h900_bestv2/${poster_path}`,
...
console.log(movieList)
  ...
  // Movies list
  //    { title: original_title , poster: https://www.themoviedb.org/t/p/w600_and_h900_bestv2/${poster_path} , voteAverage: vote_average, voteCount: vote_count , overview: overview },
